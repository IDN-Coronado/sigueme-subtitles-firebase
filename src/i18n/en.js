const en = {
  ...
  mediaImport: {
    ...
    title: 'Copy media from Firebase',
    body: "Downloads every file in the Storage bucket into the media folder on this computer, then re-points your programs and themes at the local copies. Safe to run more than once — files already downloaded are skipped.",
    action: 'Start copy',
    running: 'Copying…',
    done: '{copied} copied, {skipped} already present.',
    failed: '{count} could not be copied:',
  },
  programItems: {
