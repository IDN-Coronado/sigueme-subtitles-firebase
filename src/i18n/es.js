const es = {
  ...
  mediaImport: {
    ...
    title: 'Copiar medios desde Firebase',
    body: 'Descarga todos los archivos del bucket de Storage a la carpeta de medios de esta computadora y luego reapunta tus programas y temas a las copias locales. Se puede ejecutar más de una vez: los archivos ya descargados se omiten.',
    action: 'Iniciar copia',
    running: 'Copiando…',
    done: '{copied} copiados, {skipped} ya presentes.',
    failed: 'No se pudieron copiar {count}:',
  },
  programItems: {
