const es = {
  ...
  errors: {
    ...
    saveSong: "Error al guardar la canción.",
    addTheme: "Error al agregar el tema al programa.",
    updatePreview: "Error al enviar a la consola.",
    clearConsole: "Error al limpiar la consola.",
    showLogo: "Error al mostrar el logo.",
  },
  types: {
    song: "Canción",
    media: "Media",
